...
# Diffusion pipeline for general diffusion models. Implements train and inference functions. Diffusion parameters are defined inside a `Scheduler` object.

# %% auto #0
__all__ = ['DiffusionPipeline']

# %% ../../src/pipeline/diffusion_pipeline.ipynb #06272f6f-b4e3-4504-a90a-feebbf6ad821
from ..imports import *
...
class DiffusionPipeline(Pipeline):   
    ...
    # init methods run when object from class is created. 
    def __init__(self, 
                 scheduler: Scheduler,   
                 model: nn.Module,
