...
# circuits_generation.py creates raw arrays like x,y,U,p. This file is the generic container and I/O manager for datasets, 
# which can be used for training and evaluation. It manages loading and saving of datasets, as well as preprocessing steps 
# like balancing and splitting into train/validation sets. It also provides a memory summary function to understand the memory usage of the dataset. 
# The ConfigDataset class is designed to be flexible and can be extended for specific types of datasets by defining the store_dict and add_balance_fn attributes.
